      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          ...
          <div className="w-full md:w-auto flex flex-col md:flex-row gap-6 items-stretch md:items-center">
            {/* Sort */}
            <div className="flex gap-2 p-1 bg-white/5 rounded-full border border-white/10 w-full md:w-auto">
              <button
                onClick={() => setSortBy('year')}
                className={`flex-1 md:flex-none px-6 py-2 rounded-full text-[10px] uppercase tracking-widest transition-all text-center ${sortBy === 'year' ? 'bg-white text-black' : 'opacity-50 hover:opacity-100'}`}
              >
                Year
              </button>
              <button
                onClick={() => setSortBy('title')}
                className={`flex-1 md:flex-none px-6 py-2 rounded-full text-[10px] uppercase tracking-widest transition-all text-center ${sortBy === 'title' ? 'bg-white text-black' : 'opacity-50 hover:opacity-100'}`}
              >
                Title
              </button>
            </div>
